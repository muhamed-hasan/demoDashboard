...
export default function ReportsPage() {
  ...
  return (
    <div className="max-w-7xl mx-auto p-8">
      <h1 className="text-4xl font-bold mb-6 bg-gradient-modern bg-clip-text text-transparent">تقارير الحضور والانصراف</h1>
      ...
      {records.length > 0 && (
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
          <div className="modern-card p-6 rounded-2xl">
            ...
            <div className="text-3xl font-bold text-gray-900 dark:text-white">{records.length}</div>
          </div>
          <div className="modern-card p-6 rounded-2xl">
      ...
      <div className="overflow-x-auto mt-4">
        <table className="table-modern min-w-full divide-y divide-gray-200 dark:divide-gray-700 rounded-2xl">
          <thead>
            <tr>
                              <th className="px-6 py-3 text-left text-xs font-medium text-white uppercase tracking-wider">الرقم الوظيفي</th>
                <th className="px-6 py-3 text-left text-xs font-medium text-white uppercase tracking-wider">اسم الموظف</th>
                <th className="px-6 py-3 text-left text-xs font-medium text-white uppercase tracking-wider">القسم</th>
                <th className="px-6 py-3 text-left text-xs font-medium text-white uppercase tracking-wider">الشيفت</th>
                <th className="px-6 py-3 text-left text-xs font-medium text-white uppercase tracking-wider">التاريخ</th>
                <th className="px-6 py-3 text-left text-xs font-medium text-white uppercase tracking-wider">أول تسجيل دخول</th>
                <th className="px-6 py-3 text-left text-xs font-medium text-white uppercase tracking-wider">آخر تسجيل خروج</th>
                <th className="px-6 py-3 text-left text-xs font-medium text-white uppercase tracking-wider">ساعات العمل</th>
                <th className="px-6 py-3 text-left text-xs font-medium text-white uppercase tracking-wider">الحالة</th>
            </tr>
          </thead>
